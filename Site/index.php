...
<head>
	...
	<title>Randy Hammons | User Experience Engineer</title>
	...
	<script>(function (w, d, s, l, i) {
		...
		})(window, document, 'script', 'dataLayer', 'GTM-PFKVCP');</script>
	...
	<meta name="twitter:site" content="@optikinescant">
...
<body class="home">
	...
	<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PFKVCP" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
	<!-- End Google Tag Manager (noscript) -->

	<header role="banner" class="introduction">
		<p class="introduction__text"><span class="introduction__salutation">Hi!</span>
			<em class="introduction__first-line">I am Randy Hammons,</em>
			A user experience engineer, designer, and avid cyclist.
			Currently Senior Manager of User Experience creating
			<strong class="introduction__adjective">meaningful</strong> digital marketing
			solutions at The Adcom Group in Cleveland, Ohio.</p>
	</header>
	<footer class="footer">
		...
		<nav class="social-nav">
			...
			<ul class="social-nav__list">
				<li class="social-nav__item">
					<a href="https://www.twitter.com/optikinescant">Twitter</a>
				</li>
				<li class="social-nav__item">
					<a href="https://www.instagram.com/rhammons">Instagram</a>
				</li>
				<li class="social-nav__item">
